...
Grab the latest compiled APK from the official [GitHub Releases](https://github.com/Praveensenpai/kuro-launcher/releases):
...
git clone https://github.com/Praveensenpai/kuro-launcher.git
cd kuro-launcher
